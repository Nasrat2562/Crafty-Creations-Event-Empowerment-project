            ...
            <div class="container">
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="email" class="form-control" id="ManagerEmail" name="ManagerEmail" value="<?php echo $row['ManagerEmail']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="ManagerNumber" name="ManagerNumber" value="<?php echo $row['ManagerNumber']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
