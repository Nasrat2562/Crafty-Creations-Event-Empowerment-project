...
<head>
    ...
    <style>
        /* Custom styles */
        .navbar-custom {
            background-color: #800080; /* Change navbar background color */
        }
        .navbar-custom .navbar-brand {
            color: #fff; /* Change navbar brand color */
        }
        .navbar-custom .navbar-nav .nav-link {
            color: #fff; /* Change navbar link color */
        }
        .advertisement {
            margin-bottom: 20px;
            padding: 10px;
...
<div class="container mt-4">
    <?php
    // Display all advertisements vertically
...
<script>
    ...
    // Example jQuery for blocking advertiser (if required)
